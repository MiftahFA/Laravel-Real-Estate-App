                ...
                <div class="inner-box mr-0">
                    ...
                    <div class="content-box">
                        ...
                        <ul class="info clearfix mr-0">
                            <li><i class="fab fa fa-envelope"></i><a href="mailto:bean@realshed.com">{{ $agent->email
                                    }}</a></li>
                ...
                <div class="default-sidebar agent-sidebar">
                    ...
                    <div class="category-widget sidebar-widget">
                        ...
                        <ul class="category-list clearfix">
                            <li><a href="{{ route('rent.property') }}">For Rent <span>({{ count($rentproperty)
                                        }})</span></a></li>
                            <li><a href="{{ route('buy.property') }}">For Buy <span>({{ count($buyproperty)
                                        }})</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="featured-widget sidebar-widget">
                        ...
                        <div class="single-item-carousel owl-carousel owl-theme owl-nav-none dots-style-one">
                            ...
                            <div class="feature-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="{{ asset($feat->property_thambnail  ) }}" alt=""
