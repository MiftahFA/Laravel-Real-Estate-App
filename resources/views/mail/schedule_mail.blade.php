            ...
            <div class="bee-row-content">
                ...
                <div class="bee-col bee-col-2 bee-col-w8">
                    <div class="bee-block bee-block-1 bee-paragraph">
                        ...
                        <h3> Link : <a href="{{ $schedule['link'] }}">Klik</a></h3>
                ...
                <div class="bee-col bee-col-3 bee-col-w3">
                    ...
                    <div class="bee-block bee-block-2 bee-text">
                        <div class="bee-text-content"
                            ...
                            <p style="line-height: 18px; text-align: center;"><span style="line-height: 18px;">(+1) 123
                                    456 789</span></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bee-block bee-block-1 bee-icons">
                        <div class="bee-icon bee-icon-last">
                            <div class="bee-content">
                                <div class="bee-icon-image"><a href="https://www.designedwithbee.com/" target="_blank"
                                        title="Designed with BEE"><img alt="Designed with BEE" height="32px"
